...
@NgModule({
  declarations: [LayoutComponent, LandingComponent, ProjectsComponent, ProjectdetailsComponent, ProjectsettingsComponent, SlumphistoryComponent, NotificationsComponent, ProjectdashboardComponent],
  imports: [
    CommonModule,
